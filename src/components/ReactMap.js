...
export default function MapContainer() {
  ...
  let setSelectedFunction = (id, name) => {
    ...
    <div id="mapid" className="h-full">
      ...
      >
        ...
        {facilityData.map((facility, index) => {
          ...
          if (!capacity || !facility.location) return React.null;
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <path
                    fill="currentColor"
                    className={boxColour[2]}
                    opacity="1.00"
                    d=" M 198.09 21.39 C 219.42 21.39 240.75 21.35 262.08 21.41 C 265.35 21.26 269.20 22.63 270.14 26.10 C 271.12 30.33 270.55 34.72 270.75 39.02 C 270.23 76.33 270.58 113.66 270.69 150.98 C 271.06 155.40 267.51 159.64 262.93 159.41 C 241.29 159.54 219.63 159.45 197.98 159.46 C 198.11 113.43 197.89 67.41 198.09 21.39 Z"
                  />
                  <path
                    fill="currentColor"
                    className={boxColour[1]}
                    opacity="1.00"
                    d=" M 111.05 21.41 C 135.30 21.35 159.56 21.39 183.81 21.39 C 183.86 67.41 183.78 113.44 183.85 159.47 C 159.62 159.46 135.39 159.49 111.16 159.46 C 111.03 113.44 111.26 67.42 111.05 21.41 Z"
                  />
                  <path
                    fill="currentColor"
                    className={boxColour[0]}
                    opacity="1.00"
                    d=" M 24.25 29.06 C 23.96 24.72 27.69 21.07 32.03 21.44 C 53.78 21.34 75.54 21.33 97.29 21.45 C 97.38 67.46 97.42 113.48 97.27 159.49 C 77.16 159.45 57.05 159.46 36.95 159.49 C 33.43 159.40 29.29 160.07 26.46 157.47 C 24.21 155.30 24.18 151.92 24.11 149.01 C 24.29 109.02 24.01 69.04 24.25 29.06 Z"
                  />
                  <path
                    fill="#f6f6f6"
                    opacity="1.00"
                    d=" M 284.38 59.14 C 294.20 58.95 304.04 59.24 313.87 59.07 C 313.80 79.96 313.84 100.86 313.85 121.76 C 304.03 121.67 294.21 121.84 284.39 121.71 C 284.34 100.86 284.38 80.00 284.38 59.14 Z"
                  />
                </svg>
              </SVGOverlay>
            );
        ...
        {pseudoPopup && (
          <PopCircle
            center={[
              pseudoPopup.location.latitude,
              pseudoPopup.location.longitude,
            ]}
            fillColor="#ffffff"
            fillOpacity={0}
            stroke={false}
            ...
            <Popup>
              ...
              <div className="popup-line-wrap">
                {Object.entries(roomTypes).map(([id, name]) => {
                  if (!pseudoPopup.capacity[id]) return React.null;
                  return (
                    <span>
                      {name}: {pseudoPopup.capacity[id].current_capacity}/
