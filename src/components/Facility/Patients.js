...
const Patients = ({ patientsFiltered, date }) => {
  ...
  const renderPatientCards = () => {
    ...
    let elems = <div className="grid-col-1 grid gap-6 mb-8 md:grid-cols-4">
      {
    ...
    if (dataExists) {
      ...
      return <div className="word-wrap py-4 text-center my-4 font-bold text-2xl md:text-3xl px-2 break-words bg-gray-50 dark:bg-gray-800 rounded-md text-gray-600"><p>No Data Available</p></div>
    }
