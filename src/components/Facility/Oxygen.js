...
const Oxygen = ({ oxygenData }) => {
  const renderOxygenCards = () => {
    ...
    let elems = Object.keys(OXYGEN_TYPES_KEYS).map((k) => {
      if (oxygenData[k]) dataExists = true;
      return (
        oxygenData[k] && (
          <div
            key={k}
          ...
          >
            <div className="justify-butween flex items-center">
              ...
              <div>
                ...
                <p className="dark:text-white text-2xl font-bold">
                  {oxygenData[k]?.stock - Math.floor(oxygenData[k]?.stock) !== 0
            ...
            <div className="justify-butween flex items-center">
              ...
              <div>
                ...
                <p className="dark:text-gray-400 text-sm">Cylinders / hour</p>
              </div>
            </div>
            <div className="justify-butween flex items-center">
              <div>
              ...
              <div>
                ...
                <p className="dark:text-white text-2xl font-bold">
                  {(oxygenData[k]?.stock / oxygenData[k]?.burn_rate).toFixed(2)}
                </p>
